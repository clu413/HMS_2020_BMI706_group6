...
Parallel Coordinate Plot - Linkage by selecting Democratic States
![Parallel Coordinate Plot - Linkage by selecting Democratic States](screenshots/706screenshotPoliticalParty.png)
  
Parallel Coordinate Plot - Comparing Early vs Late Closures
...
Line graph of % change in new deaths, showing trend lines before and after school closure by political party
![Line Graph](screenshots/706screenshotLineGraph.png)
  
Heat map of % change in new positive cases by state, over time
